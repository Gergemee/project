...
public final class APIProductMap {

    private APIProductMap() {
    }

    public static List<ProductCatalog> parseProducts(JsonObject response) {
        ...
        for (JsonElement element : items) {
            ...
            ProductCatalog product = mapItem(element.getAsJsonObject());
            if (product != null) {
                result.add(product);
            }
        }
    ...
    private static ProductCatalog mapItem(JsonObject item) {
        ...
        return new ProductCatalog(id, title, category, typeCloses, priceText, priceValue, description, consumption);
    }
